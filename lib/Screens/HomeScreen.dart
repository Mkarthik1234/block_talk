...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void friendSelected(bool val, User selectedFriend) {
    setState(() {
      isChatSelected = val;
...
Widget build(BuildContext context) {
  print("Username and address in homescreen is ${widget.username} ${widget
      .useraddress}");
  if (isChatSelected) {
    print("selected friend in homescreen is ${this.selectedFriend.name}");
  }
  return Scaffold(
    body: Row(
      children: [
        ...
        SideBar(username: widget.username,useraddress: widget.useraddress,function: friendSelected),
        Expanded(
